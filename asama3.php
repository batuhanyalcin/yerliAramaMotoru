...
if(isset($_POST['urlkumesi'])){
	...
	<input type="text" name="aranan" placeholder="Aranacak keyword" value="<?php if(isset($_POST['aranan'])) echo $_POST['aranan']; ?>" /> <br />
	...
	<br /><br /><br />
	<p> <a href="home.php">Home  </a> <a href="asama1.php">Asama 1  </a> <a href="asama2.php">Asama 2</a> <a href="asama4">Asama 4</a> <a href="asama5">Asama 5</a> </p>
